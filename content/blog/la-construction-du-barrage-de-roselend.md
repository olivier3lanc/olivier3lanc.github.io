---
title: La construction du barrage de Roselend
description: Galerie de photographies anciennes de la construction du barrage de Roselend
lang: fr
layout: libdoc_page.liquid
permalink: "{{ libdocConfig.blogSlug }}/{{ page.fileSlug }}/index.html"
ogImageUrl: "https://raw.githubusercontent.com/olivier3lanc/cinematics-resources/refs/heads/master/ogimage-la-construction-du-barrage-de-roselend.avif"
tags:
    - post
    - roselend
date: 2025-09-04
photos:
    ...
    -   text: "Fin de construction vue côté Roche Parstire et le Roc du Vent en arrière-plan"
        url: "/sources/blog/la-construction-du-barrage-de-roselend/fin-construction-barrage-de-roselend-vue-roche-parstire.png"
    -   text: "Vue de la fin de construction côté col du pré"
        url: "/sources/blog/la-construction-du-barrage-de-roselend/construction-barrage-de-roselend-vue-col-du-pre.png"
    -   text: "Lac et barrage en septembre 1967"
        url: "/sources/blog/la-construction-du-barrage-de-roselend/lac-et-barrage-septembre-1967.png"
    -   text: "Le lac de Roselend vu de la berge côté col du pré en septembre 1967"
        url: "/sources/blog/la-construction-du-barrage-de-roselend/roselend-berge-col-du-pre-2-septembre-1967.png"
    -   text: "Le lac de Roselend vu de la berge côté col du pré en septembre 1967 (2)"
...
<figure>
    ...
    <figcaption>
        Installation générale du chantier de Roselend.
        <ol>
            <li>Carrière</li>
            <li>Concassage primaire</li>
            <li>Transport des pré-concassés</li>
            <li>Silos</li>
            <li>Concassage secondaire</li>
            <li>Concassage tertiaire</li>
            <li>Transporteur de mise en silos et stock secondaire agrégats classés</li>
            <li>Station lavage continu des agrégats</li>
            <li>Transporteurs d'alimentation</li>
            <li>Tours à béton</li>
            <li>Tour à béton</li>
        </ol>
    </figcaption>
...
<figure>
    <video src="https://res.cloudinary.com/doufg1wen/video/upload/v1771230176/temoignage-brice-wong-ingenieur-edf_t3offe.mp4"
        controls
        width="748"
        height="526"
        preload="auto"
